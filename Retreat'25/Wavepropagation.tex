...
\begin{frame}{Multidimensional Wave Propagation (2D and 3D)}
	...
	\begin{columns}[c]
		...
		\begin{column}{0.55\textwidth}
			...
			\textbf{Key ideas:}
			\begin{itemize}
				\item \textbf{1D Riemann problems at cell faces:}  
				Solve along the normal direction of each cell face.
		...
		\begin{column}{0.45\textwidth}
			...
			\begin{tikzpicture}[scale=0.7]
				...
				\coordinate (O) at (0,0);
				\coordinate (X) at (\a,0);
				\coordinate (Y) at (0.7*\a,0.45*\a);
				\coordinate (Z) at (0,1.0*\a);
				
				\coordinate (P000) at (0,0);
				\coordinate (P100) at ($(P000)+(X)$);
				\coordinate (P010) at ($(P000)+(Y)$);
				\coordinate (P110) at ($(P100)+(Y)$);
				\coordinate (P001) at ($(P000)+(Z)$);
				\coordinate (P101) at ($(P100)+(Z)$);
				\coordinate (P011) at ($(P010)+(Z)$);
				\coordinate (P111) at ($(P110)+(Z)$);
				
				\draw[thick] (P000) -- (P100) -- (P110) -- (P010) -- cycle;
				\draw[thick] (P001) -- (P101) -- (P111) -- (P011) -- cycle;
				\draw[thick] (P000) -- (P001);
				\draw[thick] (P100) -- (P101);
				\draw[thick] (P010) -- (P011);
				\draw[thick] (P110) -- (P111);
				
				\coordinate (Ax) at (-0.6,-0.3);
				\draw[->, thick] (Ax) -- ++(1.8,0) node[right] {\(x\)};
				\draw[->, thick] (Ax) -- ++(0.9,1.05) node[right] {\(y\)};
				\draw[->, thick] (Ax) -- ++(0,1.7) node[above] {\(z\)};
