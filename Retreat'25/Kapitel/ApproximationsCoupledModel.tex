...
\begin{frame}{Numerical Result for externally imposed velocity field}
	...
	\end{align*}
	with $w_x=1$.
	% Später wird diese Struktur in die Momentengleichungen übertragen, wo der Drift über die Matrix 
	% 𝐷(∇𝑥𝑢)) und die Diffusion über den Term 𝐷𝑟𝐸 eingeht
	% Drift = deterministische Orientierung durch Strömung (Velocity-Gradient).
	% Diffusion = zufällige Orientierung durch Rotationsdiffusion.
		\begin{figure}[H]
			\centering
