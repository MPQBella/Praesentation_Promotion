...
\begin{frame}{Stability analysis}
	\begin{figure}
		\centering
		\subfloat[Coefficients as functions of time]{\includegraphics[width=5.5cm,height=4cm]{Bilder/elongational_l=1_lsg_ueber_Zeit_2nd}}
		\qquad
...
\begin{frame}{Absolute stability: for large $D_r$}
	\begin{figure}
		...
		\end{subfigure}
		\caption{Stability region of $RK4$ with eigenvalues of $2nd$ order ODE system for $D_r=1$ and different time steps}
	\end{figure}
\end{frame}
...
\begin{frame}{Absolute stability: for large $D_r$}
	\begin{figure}
		...
		\end{subfigure}
		\caption{Stability region of $RK4$ with eigenvalues of $14th$ order ODE system for $D_r=1$ and different time steps}
	\end{figure}
