...
\begin{frame}{Stability analysis}
	\begin{figure}
		\centering
		\subfloat[Coefficients as function of time]{\includegraphics[width=5.5cm,height=4cm]{Bilder/elongational_l=1_lsg_ueber_Zeit_2nd}}
		\qquad
		\subfloat[Eigenvalues]{\includegraphics[width=5.5cm,height=3.8cm]{Bilder/Stability_analysis_2nd_dr0.1}}
...
\begin{frame}{Absolute stability: for large $D_r$}
	\begin{figure}
		...
		\end{subfigure}
		\caption{Stability region of $RK4$ with eigenvalues of $2nd$ order ODE system with $Dr=1$ and different time steps}
	\end{figure}
\end{frame}
...
\begin{frame}{Absolute stability: for large $D_r$}
	\begin{figure}
		...
		\end{subfigure}
		\caption{Stability region of $RK4$ with eigenvalues of $14th$ order ODE system with $Dr=1$ and different time steps}
	\end{figure}
...
\begin{frame}{Coefficients as function}
	\begin{figure}
		...
		\end{subfigure}
		\caption{Coefficients as function of time for $2nd$ order}
	\end{figure}
\end{frame}
...
\begin{frame}{Coefficients as function}
	\begin{figure}
		...
		\end{subfigure}
		\caption{Coefficients as function of time for $4th$ order}
	\end{figure}
\end{frame}
...
\begin{frame}{Coefficients as function}
	\begin{figure}
		...
		\end{subfigure}
		\caption{Coefficients as function of time for $6th$ order}
	\end{figure}
\end{frame}
...
\begin{frame}{Coefficients as function}
	\begin{figure}
		...
		\end{subfigure}
		\caption{Coefficients as function of time for $14th$ order}
	\end{figure}
\end{frame}
